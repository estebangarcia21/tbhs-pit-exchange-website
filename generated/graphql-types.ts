...
export function getSdk(
    ...
    return {
        ...
        PitInventory(
            variables: PitInventoryQueryVariables,
            requestHeaders?: HeadersInit
        ): Promise<PitInventoryQuery> {
            return withWrapper(() =>
                client.request<PitInventoryQuery>(
                    print(PitInventoryDocument),
                    variables,
                    requestHeaders
                )
            );
        ...
        UserAmount(
            variables?: UserAmountQueryVariables,
            requestHeaders?: HeadersInit
        ): Promise<UserAmountQuery> {
            return withWrapper(() =>
                client.request<UserAmountQuery>(
                    print(UserAmountDocument),
                    variables,
                    requestHeaders
                )
            );
