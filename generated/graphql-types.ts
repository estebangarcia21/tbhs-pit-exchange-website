 ...
 * });
 */
export function usePitInventoryQuery(baseOptions: Apollo.QueryHookOptions<PitInventoryQuery, PitInventoryQueryVariables>) {
        return Apollo.useQuery<PitInventoryQuery, PitInventoryQueryVariables>(PitInventoryDocument, baseOptions);
      }
export function usePitInventoryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<PitInventoryQuery, PitInventoryQueryVariables>) {
          return Apollo.useLazyQuery<PitInventoryQuery, PitInventoryQueryVariables>(PitInventoryDocument, baseOptions);
        }
export type PitInventoryQueryHookResult = ReturnType<typeof usePitInventoryQuery>;
export type PitInventoryLazyQueryHookResult = ReturnType<typeof usePitInventoryLazyQuery>;
export type PitInventoryQueryResult = Apollo.QueryResult<PitInventoryQuery, PitInventoryQueryVariables>;
 ...
 * });
 */
export function useUserAmountQuery(baseOptions?: Apollo.QueryHookOptions<UserAmountQuery, UserAmountQueryVariables>) {
        return Apollo.useQuery<UserAmountQuery, UserAmountQueryVariables>(UserAmountDocument, baseOptions);
      }
export function useUserAmountLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<UserAmountQuery, UserAmountQueryVariables>) {
          return Apollo.useLazyQuery<UserAmountQuery, UserAmountQueryVariables>(UserAmountDocument, baseOptions);
        }
export type UserAmountQueryHookResult = ReturnType<typeof useUserAmountQuery>;
export type UserAmountLazyQueryHookResult = ReturnType<typeof useUserAmountLazyQuery>;
export type UserAmountQueryResult = Apollo.QueryResult<UserAmountQuery, UserAmountQueryVariables>;